...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'mouryas@outlook.in'  # Your Outlook email
EMAIL_HOST_PASSWORD = 'fnan mhfh dmtc ubdh'  # Your Outlook password or app password
DEFAULT_FROM_EMAIL = 'mouryas@outlook.in'  # Default sender email
